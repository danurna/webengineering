    ...
    <body id="winnerpage">
        ...
        <section role="main">
            ...
            <section id="roundwinner" aria-labelledby="roundwinnerheading">
                ...
                <% if (game.getGamesWonPlayer1() == game.getGamesWonPlayer2()) { %>
                <p class="roundwinnermessage">Unentschieden!</p>
                <% } else if (game.getGamesWonPlayer1() > game.getGamesWonPlayer2()) { %>
                <p class="roundwinnermessage">Spieler 1 gewinnt!</p>
                <% } else if (game.getGamesWonPlayer1() < game.getGamesWonPlayer2()) { %>
            ...
            <section id="roundinfo" aria-labelledby="roundinfoheading">
                ...
                <div id="player1info" class="playerinfo">
                    ...
                    <p id="player1roundcounter" class="playerroundcounter">Gewonnene Runden: <span id="player1wonrounds" class="playerwonrounds"><%=game.getGamesWonPlayer1() %></span></p>
                </div>
                <div id="player2info" class="playerinfo">
                    <span id="player2name" class="playername">Spieler 2</span>
                    <p id="player2roundcounter" class="playerroundcounter">Gewonnene Runden: <span id="player2wonrounds" class="playerwonrounds"><%=game.getGamesWonPlayer2() %></span></p>
                </div>
                <!-- <a id="next" href="question.html" accesskey="n">Neues Spiel</a> -->
                <form action="BigQuizServlet" method="get">
					<input type="hidden" name="action" value="start" />
					<input type="submit" value="Neues Spiel" id="next" />
				</form>
            </section>
        </section>
